...
puts "Welcome to the calculator, what would you like to do? 1)multiply, 2) divide, 3)add, 4) subtract, 5)modulo"
prompt = gets.chomp
...
if prompt.to_i == 1
  ...
  puts "You have chosen to divide #{first_number} to #{second_number}"
